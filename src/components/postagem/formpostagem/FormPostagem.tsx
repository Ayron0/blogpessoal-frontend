...
function FormPostagem() {
  ...
  }// Essa parte do código é sobre o relacionamento das tabelas

  function retornar() {
    navigate("/postagens");
  }

  // FormEvent<HTMLFormElement> é um evento de formulario que vai mandar as informações para o back-end
    ...
    <div className="container flex flex-col items-center mx-auto">
      ...
      <form className="w-1/2  flex flex-col gap-4" onSubmit={gerarNovaPostagem}>
        ...
        <div className=" flex flex-col gap-2">
          ...
          > {/*e.currentTarget.value - ele vai pegar apenas o valo/opção que foi clicado*/}
