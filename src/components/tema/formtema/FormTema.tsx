...
function FormTema() {
  ...
  //({} as Tema) serve para informar que o estado inicial será um objeto do tipo Tema e que será um objeto vazio
  ...
  async function gerarNovoTema(e: FormEvent<HTMLFormElement>) {
    ...
    if (id  !== undefined) {
      ...
      try {
        ...
        ToastAlerta("O Tema cadastrado com sucesso!", "sucesso")
      } catch (error: any) {
        if (error.toString().includes('401')) {
          handleLogout();
        } else {
